        ...
        <v-card>
                  ...
                  >
                    <v-container class="ma-0 pa-0">
                      <v-row dense no-gutters class="ma-0 pa-0">
                        ...
                        <v-col cols="8">
                          <v-radio-group v-model="addform.score" row style="width=:100%;transform:scale(0.75,0.75);"
                                         class="ma-2 pa-0">
                            <v-radio
                  ...
                  >
                    <v-container class="ma-0 pa-0">
                      <v-row dense no-gutters class="ma-0 pa-0">
                        ...
                        <v-col cols="8">
                          <v-radio-group v-model="addform.isatcollege" row
                        ...
                        <v-col cols="8">
                          <v-radio-group v-model="addform.ischangedbranch" row
                                         style="width=:100%;transform:scale(0.75,0.75);" class="ma-2 pa-0">
                            <v-radio
          ...
          <v-card-actions>
            <div style="margin:0 auto;">
              ...
              <v-btn color="rgba(71, 112, 166, 0.996078431372549)" @click="saveadd()" dark depressed
      ...
      <div style="min-width:960px;">
        <v-dialog v-model="changedialog" width="1200px">
          <v-card>
                    ...
                    >
                      <v-container class="ma-0 pa-0">
                        <v-row dense no-gutters class="ma-0 pa-0">
                          ...
                          <v-col cols="8">
                            <v-radio-group v-model="changeform.score" row
                                           style="width=:100%;transform:scale(0.75,0.75);" class="ma-2 pa-0">
                              <v-radio
                                  v-for="i in scoreradiochoice"
                                  :key="i"
                    ...
                    >
                      <v-container class="ma-0 pa-0">
                        <v-row dense no-gutters class="ma-0 pa-0">
                          ...
                          <v-col cols="8">
                            <v-radio-group v-model="changeform.isatcollege" row
                                           style="width=:100%;transform:scale(0.75,0.75);" class="ma-2 pa-0">
                              <v-radio
                                  v-for="i in isatcollegeradiochoice"
                                  :key="i"
                          ...
                          <v-col cols="8">
                            <v-radio-group v-model="changeform.ischangedbranch" row
                                           style="width=:100%;transform:scale(0.75,0.75);" class="ma-2 pa-0">
                              <v-radio
                                  v-for="i in ischangedbranchradiochoice"
                                  :key="i"
            ...
            <v-card-actions>
              <div style="margin:0 auto;">
                <v-btn color="rgba(71, 112, 166, 0.996078431372549)" @click="savechange(item)" dark depressed
    ...
    confirmfilter() {
      ...
      if (this.schoolidfilterstr == '' && this.formaltimefilterstr == '' && this.branchfilterstr == '') {
        ...
        if (this.formaltimefilterstr != '') {
          this.filtereddesserts = this.filtereddesserts.filter((val) => {
            return val.formaltime.indexOf(this.formaltimefilterstr) != -1
          });
        }
        if (this.branchfilterstr != '') {
          this.filtereddesserts = this.filtereddesserts.filter((val) => {
            return val.branch.indexOf(this.branchfilterstr) != -1
          });
        }
      }
    },
