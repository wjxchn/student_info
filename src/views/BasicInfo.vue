        ...
        <v-card>
                ...
                <v-row dense no-gutters>
                    ...
                    <v-container fluid class="ma-0 pa-0">
                      <v-row dense no-gutters class="ma-0 pa-0">
                        ...
                        <v-col cols="8" class="ma-0 pa-0">
                          <input type="file" id="upload" ref="upload" @change="addimg" accept=".jpg, .jpeg, .png"
                  ...
                  >
                    <v-container fluid class="ma-0 pa-0">
                      <v-row dense no-gutters class="ma-0 pa-0">
                        ...
                        <v-col cols="8" class="ma-0 pa-0">
                          <v-radio-group v-model="addform.iscared" row style="width=:100%;transform:scale(0.75,0.75);"
                                         class="ma-2 pa-0">
                            <v-radio
                  ...
                  >
                    <v-container fluid class="ma-0 pa-0">
                      <v-row dense no-gutters class="ma-0 pa-0">
                        ...
                        <v-col cols="8" class="ma-0 pa-0">
                          <v-radio-group v-model="addform.ispoverty" row style="width=:100%;transform:scale(0.75,0.75);"
                                         class="ma-2 pa-0">
                            <v-radio
                                v-for="i in yesornolist"
                                :key="i"
                    ...
                    <v-container fluid class="ma-0 pa-0">
                      <v-row dense no-gutters class="ma-0 pa-0">
                        ...
                        <v-col cols="8" class="ma-0 pa-0">
                          <v-radio-group v-model="addform.istemporaryhelpapplied" row
                  ...
                  >
                    ...
                    <v-container fluid class="ma-0 pa-0">
                      <v-row dense no-gutters class="ma-0 pa-0">
                        <v-col cols="4" class="ma-0 pa-0">
                          <v-subheader class="ma-0 pa-0" style="font-size:10px;">专职辅导员</v-subheader>
                        </v-col>
                        <v-col cols="8" class="ma-0 pa-0">
                          <v-select
                              :items="['王婧仪', '何巍', '于秋漫', '毛吾吉达']"
                              v-model="addform.fulltimeguider"
                              outlined
                              dense
                              style="font-size:15px;width:100%;transform:scale(0.75,0.75);"
                          ></v-select>
                    ...
                    <v-container fluid class="ma-0 pa-0">
                      <v-row dense no-gutters class="ma-0 pa-0">
                        <v-col cols="4" class="ma-0 pa-0">
                          <v-subheader class="ma-0 pa-0" style="font-size:10px;">兼职辅导员</v-subheader>
                        </v-col>
                        <v-col cols="8" class="ma-0 pa-0">
                          <v-select
                              :items="['王楠', '他旭翔', '梁保宇', '张重庆', '李婧怡', '张华梁', '李小冉', '王嘉凯', '张艺璇', '赵世纪', '李何贝子', '张凯宁', '王康明','廖天禧']"
                              v-model="addform.partimeguider"
                              outlined
                              dense
                              style="font-size:15px;width:100%;transform:scale(0.75,0.75);"
                          ></v-select>
                    ...
                    <v-container fluid class="ma-0 pa-0">
                      <v-row dense no-gutters class="ma-0 pa-0">
                        ...
                        <v-col cols="8" class="ma-0 pa-0">
                          <v-radio-group v-model="addform.isschoolended" row
                                         style="width=:100%;transform:scale(0.75,0.75);" class="ma-2 pa-0">
                            <v-radio
                                v-for="i in yesornolist"
                                :key="i"
          ...
          <v-card-actions>
            <div style="margin:0 auto;">
              <v-btn color="#EBECF1" @click="adddialog = false" dark depressed
                     style="color:rgba(71, 112, 166, 0.996078431372549);margin-top:10px;margin-right:10px;margin-bottom:10px;">
                取消
              </v-btn>
              <v-btn color="rgba(71, 112, 166, 0.996078431372549)" @click="addStuInfo()" dark depressed
                     style="margin-top:10px;margin-left:10px;margin-bottom:10px;">添加
              </v-btn>
            </div>
          </v-card-actions>
        </v-card>
      ...
      <div style="min-width:960px;">
        ...
        >
          <v-card>
                    ...
                    <v-col class="ma-0 pb-12" cols="12" xs="3" sm="3" md="3" lg="3" xl="3">
                      ...
                      <v-container fluid class="ma-0 pa-0">
                        <v-row dense no-gutters class="ma-0 pa-0">
                          ...
                          <v-col cols="8" class="ma-0 pa-0">
                            <v-radio-group v-model="changeform.sex" row style="width=:100%;transform:scale(0.75,0.75);"
                                           class="ma-2 pa-0">
                              <v-radio
                    ...
                    <v-col class="ma-0 pb-12" cols="12" xs="3" sm="3" md="3" lg="3" xl="3">
                      <v-container fluid class="ma-0 pa-0">
                        <v-row dense no-gutters class="ma-0 pa-0">
                          ...
                          <v-col cols="8" class="ma-0 pa-0">
                            <v-radio-group v-model="changeform.iscared" row
                                           style="width=:100%;transform:scale(0.75,0.75);" class="ma-2 pa-0">
                              <v-radio
                                  v-for="i in yesornolist"
                                  :key="i"
                    ...
                    <v-col class="ma-0 pb-12" cols="12" xs="3" sm="3" md="3" lg="3" xl="3">
                      <v-container fluid class="ma-0 pa-0">
                        <v-row dense no-gutters class="ma-0 pa-0">
                          ...
                          <v-col cols="8" class="ma-0 pa-0">
                            <v-radio-group v-model="changeform.ispoverty" row
                                           style="width=:100%;transform:scale(0.75,0.75);" class="ma-2 pa-0">
                              <v-radio
                                  v-for="i in yesornolist"
                                  :key="i"
                      ...
                      <v-container fluid class="ma-0 pa-0">
                        <v-row dense no-gutters class="ma-0 pa-0">
                          ...
                          <v-col cols="8" class="ma-0 pa-0">
                            <v-radio-group v-model="changeform.istemporaryhelpapplied" row
                                           style="width=:100%;transform:scale(0.75,0.75);" class="ma-2 pa-0">
                              <v-radio
                                  v-for="i in yesornolist"
                                  :key="i"
                    ...
                    <v-col class="ma-0 pb-12" cols="12" xs="3" sm="3" md="3" lg="3" xl="3">
                      ...
                      <v-container fluid class="ma-0 pa-0">
                        <v-row dense no-gutters class="ma-0 pa-0">
                          ...
                          <v-col cols="8" class="ma-0 pa-0">
                            <v-select
                                :items="['王婧仪', '何巍', '于秋漫', '毛吾吉达']"
                                v-model="changeform.fulltimeguider"
                                outlined
                                dense
                                style="font-size:15px;width:100%;transform:scale(0.75,0.75);"
                            ></v-select>
                      ...
                      <v-container fluid class="ma-0 pa-0">
                        <v-row dense no-gutters class="ma-0 pa-0">
                          ...
                          <v-col cols="8" class="ma-0 pa-0">
                            <v-select
                                :items="['王楠', '他旭翔', '梁保宇', '张重庆', '李婧怡', '张华梁', '李小冉', '王嘉凯', '张艺璇', '赵世纪', '李何贝子', '张凯宁', '王康明','廖天禧']"
                                v-model="changeform.partimeguider"
                                outlined
                                dense
                                style="font-size:15px;width:100%;transform:scale(0.75,0.75);"
                            ></v-select>
                      ...
                      <v-container fluid class="ma-0 pa-0">
                        <v-row dense no-gutters class="ma-0 pa-0">
                          ...
                          <v-col cols="8" class="ma-0 pa-0">
                            <v-radio-group v-model="changeform.isschoolended" row
                                           style="width=:100%;transform:scale(0.75,0.75);" class="ma-2 pa-0">
                              <v-radio
                                  v-for="i in yesornolist"
                                  :key="i"
            ...
            <v-card-actions>
              <div style="margin:0 auto;">
                <v-btn color="rgba(71, 112, 166, 0.996078431372549)" @click="saveupdate(item)" dark depressed
                       style="margin-top:10px;margin-left:10px;margin-bottom:10px;">保存更改
                </v-btn>
              </div>
            </v-card-actions>
          </v-card>
        ...
        >
          ...
          <template v-slot:item.operation="{item}">
            <v-btn depressed small style="background-color:white;border:1px solid grey;" @click="changefunc(item)"
                   @click.stop="changedialog = true">编辑
            </v-btn>
            <v-btn depressed small
                   style="margin-left:30px;background-color:rgba(71, 112, 166, 0.996078431372549);color:white;"
                   @click="deleteInfo(item)">删除
            </v-btn>
          </template>
        </v-data-table>
      </div>
...
export default {
  ...
  data() {
    return {
      ...
      checkinfolist: [
        ...
        ['班号', 'classnum', false],
        ['专职辅导员', 'fulltimeguider', false],
        ['兼职辅导员', 'partimeguider', false],
      ...
      infolist: [
        ...
        ['班号', 'classnum', true],
        ['专职辅导员', 'fulltimeguider', true],
        ['兼职辅导员', 'partimeguider', true],
  ...
  methods: {
    ...
    changefunc(item) {
      ...
      this.changeform.fulltimeguider = item.fulltimeguider;
      this.changeform.partimeguider = item.partimeguider;
    ...
    confirmfilter() {
      ...
      if (this.schoolidfilterstr == '' && this.schoolstartyearfilterstr == '' && this.guiderfilterstr == '' && this.studenttypefilterstr == '') {
        ...
        if (this.schoolidfilterstr != '') {
          this.filtereddesserts = this.filtereddesserts.filter((val) => {
            return val.schoolid.indexOf(this.schoolidfilterstr) != -1
          });
        }
        if (this.schoolstartyearfilterstr != '') {
          this.filtereddesserts = this.filtereddesserts.filter((val) => {
            return val.schoolstartyear.indexOf(this.schoolstartyearfilterstr) != -1
          });
        }
        if (this.guiderfilterstr != '') {
          this.filtereddesserts = this.filtereddesserts.filter((val) => {
            return val.guider.indexOf(this.guiderfilterstr) != -1
          });
        }
        if (this.studenttypefilterstr != '') {
          this.filtereddesserts = this.filtereddesserts.filter((val) => {
            return val.studenttype.indexOf(this.studenttypefilterstr) != -1
          });
        }
      }
    },
